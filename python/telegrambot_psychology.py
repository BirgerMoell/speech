...
from chatbot import ask_psychologist
from dotenv import load_dotenv
load_dotenv('.env')

telegram_api_key = os.getenv("TELEGRAM_API_KEY_PSYCHOLOGY")
...
def echo(update: Update, _: CallbackContext) -> None:
    ...
    response = ask_psychologist(update.message.text, start_chat_log_psychologist) 
